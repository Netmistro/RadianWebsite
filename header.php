...
<html lang="en">
    ...
    <body>
        ...
        <div class="nav-wrapper" style="height:40px;">
            <div class="main" id="main-nav-bar">
                <ul class="mainnav">
                    <li><a href="./index.php">Home</a></li>
                    <li class="hassubs"><a href="JavaScript:void(0)">Products</a>
                        <ul class="dropdown">
                            <!-- Single Menu Items -->
                            ...
                            <li class="subs hassubs"><a href="JavaScript:void(0)">Scaffolding</a>
                                <ul class="dropdown">
                                    ...
                                    <li class="subs"><a href="./ringlock.php">Ring Lock</a></li>
                                    <li class="subs"><a href="./scaffold-mart.php">H-Frames</a></li>
                                    <li class="subs"><a href="./boss-towers.php">Boss Towers</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="subs hassubs"><a href="JavaScript:void(0)">Work at Heights</a>
                                <ul class="dropdown">
                            ...
                            <li class="subs hassubs"><a href="JavaScript:void(0)">Scaffold Tools</a>
                                <ul class="dropdown">
                                    <li class="subs"><a href="./scaffold-spanners.php">Spanners</a></li>
                                    <li class="subs"><a href="./scaffold-levels.php">Levels</a></li>
                                    <li class="subs"><a href="./measuring-tape.php">Measuring Tape</a></li>
                                    <li class="subs"><a href="./hammers-mallets.php">Hammers & Mallets</a></li>
                                </ul>
                            </li>

                            <!-- Leather Products Sub Menu -->
                            <li class="subs hassubs"><a href="JavaScript:void(0)">Leather Products</a>
                                <ul class="dropdown">
                                    <li class="subs"><a href="./spanner-frogs.php">Spanner Frogs</a></li>
                    ...
                    <!-- Services Menu -->
                    <li class="hassubs"><a href="JavaScript:void(0)">Services</a>
                        <ul class="dropdown">
                    ...
                    <li class="hassubs"><a href="JavaScript:void(0)">Technical</a>
                        <ul class="dropdown">
                            ...
                            <!-- Scaffold Catalogs Sub Menu -->
                            <li class="subs hassubs"><a href="JavaScript:void(0)">Catalogs</a>
                                <ul class="dropdown">
                                    <li class="subs"><a href="./tools-gears.php">Tools & Gears</a></li>
                                    <li class="subs"><a href="./company-brochure.php">Company Brochure</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
