...
<div class="calculator-page">
    ...
    <h1>Scaffold Weight Calculator v2</h1>
    <br>
    <form name="scaffolding-calculator" method="POST" action="scaffold-calc.php">
        <input type="submit" name="calculate" value="Calculate">
        <input type="submit" onclick='document.getElementsByName("").value="";' name="clear" value="Clear"><br>
        <table class="calc-table">
            ...
            while ($rowMaterial = mysqli_fetch_assoc($scaffoldWeightData)) {
                ...
                if (isset($_POST['clear'])) {
                    header('Location: scaffold-calc.php');
                }
                ?>
                <tr>
                    ...
                    <td style="text-align: center"><input type="text"
                                                          id=<?php echo $materialID; ?> name="<?php echo $materialID; ?>"
